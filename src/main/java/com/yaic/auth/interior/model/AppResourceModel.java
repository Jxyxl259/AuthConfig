...
public class AppResourceModel extends BaseDto implements Serializable {
	
	private static final long serialVersionUID = AppResourceModel.class.getName().hashCode();
