...
public class PublicParamters implements CommandLineRunner {
	 ...
	 * 对外接口默认创建人修改人
	 */
	public static final String PDMS_DEFAULT_CREATED_USER = "pdms";
	
	public static final String DEFAULT_PROJECT_NAME = "默认方案";
...
//	public static String ENCRYPT_TYPE_RSA;
	public static String ENCRYPT_TYPE_HISTORY_ENCRYPT;
	/** 4  不加密 */
	 ...
	 */
	/** 0	开发 */
	public static String SERVER_STATUS_0;
	/** 1	上线 */
	public static String SERVER_STATUS_1;
	/** 3	暂停 */
	public static String SERVER_STATUS_3;
	/** 5	下线 */
	public static String SERVER_STATUS_5;
	/** 9	兼容 */
	public static String SERVER_STATUS_9;
