...
public interface AccountService {
	...
	*/
	...
	/** 
	* @Title: getAccountInfoByCodeOrName 
	* @Description: 根据字符串获取CODE或者NAME符合的数据集合 
	* @param accountModel
	* @return  
	* @return List<AccountModel>  
	* @throws 
	*/
	public List<AccountModel> getAccountInfoByCodeOrName(AccountModel accountModel) throws Exception;
